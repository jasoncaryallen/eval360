...
RSpec.describe Histogram, type: :model do
  ...
  let(:peer_evaluation_1) {
    FactoryBot.create(:evaluation,
      participant: participant,
      completed: true)
  }
  let(:peer_evaluation_2) {
    FactoryBot.create(:evaluation,
      participant: participant,
      completed: true)
  }
  ...
  let!(:answer_1) {
    FactoryBot.create(:answer, evaluation: peer_evaluation_1,
      numeric_response: numeric_answer_1,
      question: question)
  }
  let!(:answer_2) {
    FactoryBot.create(:answer, evaluation: peer_evaluation_2,
