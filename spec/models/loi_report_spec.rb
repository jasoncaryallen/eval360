...
RSpec.describe LoiReport, type: :model do
  ...
  let!(:questionnaire_template1) {
    FactoryBot.create(:questionnaire_template,
      questionnaire: questionnaire,
      section: section1)
  }
  let!(:questionnaire_template2) {
    FactoryBot.create(:questionnaire_template,
      questionnaire: questionnaire,
      section: section2)
  }
  let(:training) {
    FactoryBot.create(:training, questionnaire: questionnaire,
      name: "SuperBowl")
  }
  ...
  describe "#average_section_score" do
    ...
    let(:evaluation1) {
      FactoryBot.create(:evaluation, participant: participant,
    ...
    let!(:answer1) {
      FactoryBot.create(:answer, numeric_response: 4,
        question: question, evaluation: evaluation1)
    }
    let!(:answer2) {
      FactoryBot.create(:answer, numeric_response: 10,
