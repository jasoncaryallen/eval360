...
class EvaluationEmailer
  class << self
    ...
    def remind_peers_reminder(participant)
    ...
    def send_evaluation_done(participant)
    ...
    def send_to_participant(template_name, participant)
      message = participant_message(participant)
      send_template(template_name, message)
    end
    ...
    def send_template(template_name, message)
    ...
    def generate_message(evaluations)
    ...
    def participant_message(participant)
      training = participant.training
      {
